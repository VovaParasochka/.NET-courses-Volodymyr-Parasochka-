...
namespace CannonGame
{
    ...
    // class defines the different types of ammunition
    ...
    internal class Bullet
    {
        ...
        public List<Vector2> Trail = new();   // Stores previous positions for the trail
    ...
    {
        public Vector2 Position;
        public float Angle = -45f;      // Aiming angle
        ...
        // Draws artyllery with a rotating barrel
        public void Draw()
        {
    ...
    internal class Program
    {
        ...
        // Creates a new random hilly terrain every round
        ...
        // Main update decides what to update depending on current screen
        ...
        private static void UpdateInGame(float dt)
        {
            ...
            // If bullrt stop give to next player turn 
            if (currentBullet != null && !currentBullet.IsActive)
            {
                currentBullet = null;
                isShooting = false;
                currentPlayer = currentPlayer == 1 ? 2 : 1;
                wind = rand.Next(-48, 49);   // random wind 
